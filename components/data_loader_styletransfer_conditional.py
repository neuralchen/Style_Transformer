...
# -*- coding:utf-8 -*-
#############################################################
# File: data_loader_styletransfer_conditional.py
...
if __name__ == "__main__":
    ...
    style_images = "/disk1/cxh/styletransfer_data/Art_Data/data_art_backup/"
    selected_imgs = ['a/abbey', 'a/arch', 'a/amphitheater', 'a/aqueduct', 'a/arena/rodeo', 'a/athletic_field/outdoor',
